...
import { createMultiAgentDslServices, isModel } from "multi-agent-dsl-language";

let services: ReturnType<typeof createMultiAgentDslServices>;
let parse:    ReturnType<typeof parseHelper<Model>>;
let document: LangiumDocument<Model> | undefined;

beforeAll(async () => {
    services = createMultiAgentDslServices(EmptyFileSystem);
    const doParse = parseHelper<Model>(services.MultiAgentDsl);
