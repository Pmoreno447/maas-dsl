...
- [src/multi-agent-dsl.langium](src/multi-agent-dsl.langium) -  The grammar definition of your language
- [src/multi-agent-dsl-module.ts](src/multi-agent-dsl-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/multi-agent-dsl-validator.ts](src/multi-agent-dsl-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/multi-agent-dsl.monarch.ts](src/syntaxes/multi-agent-dsl.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/multi-agent-dsl.tmLanguage.json](syntaxes/multi-agent-dsl.tmLanguage.json) - Textmate based syntax highlighting instructions.
